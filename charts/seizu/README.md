...
The dedicated worker defaults to `ghcr.io/mappedsky/seizu-cartography:4.2.0.dev1`. It contains Cartography 0.139.0 and the thin Temporal activity worker, and does not receive the main Seizu Secret.
